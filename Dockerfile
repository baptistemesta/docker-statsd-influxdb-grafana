...
COPY grafana/dashboard.yaml /usr/share/grafana/conf/provisioning/dashboards/dashboard.yaml
COPY grafana/datasource.yaml /usr/share/grafana/conf/provisioning/datasources/datasource.yaml
